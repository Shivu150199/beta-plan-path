            ...
            <section className="w-[100%] flex flex-col bg-creambg">
                ...
                {page == "addDetails" && (
                    <div className="flex items-center justify-start p-4 bg-white border-t-[1px] h-[68vh] overflow-auto  no-scrollbar w-[100%]">
                        <form
                            action=""
                            className="flex flex-col gap-4 w-full lg:w-[80%] h-[100%]"
                        >
                            {/*  */}
                            <div className="flex items-center justify-between gap-8 pt-6 flex-col sm:flex-row">
                                ...
                                <Input
                                    label="Coruse code"
                                    type="number"
                                    placeholder="Enter course code assign by institute "
                                />
                            </div>
                            {/*  */}
                            <div className="flex">
                            ...
                            <div className="flex gap-4 flex-col sm:flex-row">
                                <div className="flex flex-col gap-2 ">
                                    <label className="text-base font-medium text-dark_gray">
                                        Add Course Image
                                    </label>
                                    <input
                                        ref={fileName}
                                        type="file"
                                        className="input input-bordered  rounded-[4px] outline-none placeholder:text-placeholder hidden"
                                        onChange={handleImageChange}
                                    />
                                    <div
                                        className="relative flex items-center justify-center sm:w-44 h-24 border-[1px] rounded-md overflow-hidden"
                                ...
                                <div className="w-full flex flex-col gap-2">
                                    <label
                                        htmlFor=""
                                        className="text-base font-medium text-dark_gray"
                                    >
                                        Course Short Description{" "}
                                    </label>
                                    <textarea
                                        placeholder="Add short course description"
                                        className="resize-none h-24 input-bordered input"
                                        cols={30}
                                        maxLength={1000}
                                        minLength={10}
                                    ></textarea>
                                    <p className="text-[10px] text-placeholder font-normal">
                                        0/1000
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 pb-20">
                                ...
                                />
                                <Select
                                    label="Course Length/ Duration"
                                    placeholder="Select course length/ curation"
                                    list={[]}
                                />
                                <Select
                                    label="Course Level"
                                ...
                                />
                                <Select
                                    label="Career Tech Electives"
                                    placeholder="Select career tech electives"
                                    list={[]}
                                />
                                <Select
                                    label="Max GPA unweight"
                                    placeholder="Select max GPA unweight"
                                    list={[]}
                                />
                                <Select
                                    label="Has Prerequisites"
                                    placeholder="Select prerequisites type"
                                    list={[]}
                                />
                                <Select
                                    label="Prerequiste course code"
                                    placeholder="Select prerequiste course code"
                                    list={[]}
                                />
                                <Input
                                    label="Required"
                                ...
                                <Select
                                    label="End of course"
                                    placeholder="Select end of course type"
                                    list={[]}
                                />
                                <Select
                                    label="Offered in grade"
                                    placeholder="Select offered in grade"
                                    list={[]}
                                />
                                <Select
                                    label="Offered in grade"
                                ...
                                <Input
                                    type="text"
                                    label="Additional Couse information"
                                    placeholder="Additional Couse information"
                                    list={[]}
                                />
                                <Select
                                    type="text"
                                    label="Course reference"
                                    placeholder="Enter course reference"
                                    list={[]}
                                />
                                <Select
                                    label="Course reference type"
                                    placeholder="Select course reference type"
                                    list={[]}
                                />
                                <Input
                                    type="text"
                                    label="Additional References"
                                    placeholder="Enter additional references link"
                                    list={[]}
                                />
                            </div>
                            {/*  */}
                ...
                {page == "faq" && faqList ? (
                    ...
                    <>
                        ...
                        {page == "faq" && !faq && (
                            <NoFaq faqValue={faq} faqSet={setFaq} />
                        )}
                    </>
                )}
                ...
                <div className="px-4 py-3 flex gap-10 items-center justify-end fixed w-[100%] bottom-0 bg-white shadow-[0px_-3px_6px_0px_rgba(0,_0,_0,_0.1)]">
                    ...
                    {page === "faq" ? (
                        <button
                            ...
                            className="bg-primary text-white py-1 px-4 text-sm font-medium rounded-md "
                        >
                            Submit
                        </button>
                    ) : (
