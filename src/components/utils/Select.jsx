...
<label htmlFor="" className='text-base font-medium text-dark_gray'>{label}</label>
   <select style={{background:`url(${angleDown})`,backgroundRepeat:'no-repeat',backgroundPosition:'calc(100% - 10px) center',backgroundRepeat:'no-repeat'}} className="select  select-bordered w-full rounded-[4px] outline-none placeholder:text-placeholder">
